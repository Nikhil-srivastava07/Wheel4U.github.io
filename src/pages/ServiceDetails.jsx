            ...
            Row > {
                isPending && < h6 className = "text-center" > Loading...... < /h6>} {
                    error ? ( <
                        ...
                        ServiceDetailsLeft / >
                        <
                        div className = "mt-5 p-4 text-center single__service"
                        style = {
                            { background: '#f9a826' } } >
                        <
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.Fuga veritatis necessitatibus totam repellat, amet saepe ?
                        <
                        /p>
                        ...
                        md = "8"
                        sm = "8"
                        className = "single__service__right" >
                        <
                        ...
                        <
                        /div> <
                        p className = "section__description mb-5" > { service.description } <
                        /p> <
                        Accordion / >
                        <
                        /Col> <
