    ...
    return ( <
        ...
        ListGroup > {
            QUICK__LINKS.map((item, index) => ( <
                ListGroupItem className = "p-0 mt-3 quick__links"
                key = { index } >
                <
        ...
        Jaipur, Rajasthan <
        /p> <
        p className = "head__office" > Phone : +91 123 456 7890 < /p> <
        p className = "head__office" > Email: wheel4u @gmail.com < /p> <
        p className = "head__office" > Office Time: 10 am - 6 pm < /p> <
        /div> <
        /Col>
        ...
        span > Nikhil Srivastava < /span>. All Rights Reserved <
        /p> <
        /div> <
        /Col> <
        /Row> <
